...
def main():
    ...
    with open(args.save_csv_name, 'w') as f:
        writer = csv.writer(f)
        writer.writerow(["width", "train_acc", "test_acc", "time"])

        for width in [32, 64, 128, 256, 512, 1024, 2048, 5000, 10000, 15000, 20000]:    #widthの配列  32, 64, 128, 256, 512, 1024, 2048, 5000, 10000
            ...
            writer.writerow([width, train_acc, test_acc, elapsed_time])
