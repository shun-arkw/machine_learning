...
def main():
    ...
    with open(args.save_csv_name, 'w') as f:
        ...
        for width in [128]:    #widthの配列

            for layerNum in [1, 3, 5, 7, 9, 11]: #1, 3, 5, 7, 9, 11
                ...
                writer.writerow([width, layerNum, train_acc, test_acc, elapsed_time])
